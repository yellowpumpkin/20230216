<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $select_stmt = $conn->prepare("SELECT * FROM tbl_status WHERE sid = :sid");
        $select_stmt->bindParam(':sid', $id);
        $select_stmt->execute();
        $row = $select_stmt->fetch(PDO::FETCH_ASSOC);

        // Delete an original record from db
        $delete_stmt = $conn->prepare('DELETE FROM tbl_status WHERE sid = :sid');
        $delete_stmt->bindParam(':sid', $id);
        $delete_stmt->execute();
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">เพิ่มข้อมูลสถานะ</h5>
                ...
                <form id="myform1" name="form1" method="post" class="row g-3" action=db_general.php novalidate>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="status_name" class="col-form-label">สถานะ</label>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="insert_status" class="btn btn-primary">Save</button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse in" id="Adepartment">
                                <ul id="">
                                    ...
                                    <li id="" class="nav-item ">
                                        <a class="nav-link active" href="manage_status.php">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">จัดการข้อมูลสถานะ</h4>
                            </div>
                            <div class="row">
                                <div class="card-body">
                    ...
                    ?>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    $select_stmt = $conn->prepare("select * from tbl_status ");
                                                    $select_stmt->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-warning"
                                                            data-toggle="modal"
                                                            data-target="#exampleModalCenter<?php echo $row["sid"]; ?>">Edit<i
                                                                class="fa fa-gear"></i></button>
                                                    </td>
                                                    <td><a href="?delete_id=<?php echo $row["sid"]; ?>"
                                                ...
                                                <div class="modal fade"
                                                    id="exampleModalCenter<?php echo $row["sid"]; ?>" tabindex="-1"
